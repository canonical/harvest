...
fn ensure_cloned_creates_repo_directory() {
    ...
    let cfg = RepoConfig { name: "myrepo".into(), url: fixture.url(), browse_url: None, refs: None };
...
fn ensure_cloned_returns_correct_path() {
    ...
    let cfg = RepoConfig { name: "testrepo".into(), url: fixture.url(), browse_url: None, refs: None };
