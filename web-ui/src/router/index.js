...
const routes = [
  ...
  { path: '/issues',          redirect: '/change-requests' },
  { path: '/issues/:id',      redirect: to => `/change-requests/${to.params.id}` },
  { path: '/change-requests',          component: () => import('../views/ChangeRequestsView.vue'),          meta: { requiresProject: true, directEntry: true } },
  { path: '/change-requests/:id',      component: () => import('../views/IssueDetailView.vue'),             meta: { requiresProject: true, directEntry: true } },
