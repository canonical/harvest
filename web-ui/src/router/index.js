...
const routes = [
  ...
  { path: '/deployments',     component: () => import('../views/DeploymentsView.vue'),     meta: { requiresProject: true } },
  { path: '/deployments/:id', component: () => import('../views/DeploymentDetailView.vue'), meta: { requiresProject: true, directEntry: true } },
  { path: '/issues',         component: () => import('../views/IssuesView.vue'),         meta: { requiresProject: true } },
  { path: '/issues/:id',     component: () => import('../views/IssueDetailView.vue'),     meta: { requiresProject: true, directEntry: true } },
