<template>
  <div class="design-gen" data-testid="deploy-generation">
    <div class="design-gen__header">
      ...
      <h2 class="design-gen__title">Generating deployment artifacts</h2>
    ...
    <div v-if="!started && !error" class="design-gen__spinner" data-testid="deploy-gen-spinner">
      <span class="loading-dots"><span>.</span><span>.</span><span>.</span></span>
    </div>

    <div v-if="intent || phase" class="design-gen__status-bar">
      <span v-if="intent" class="intent-badge" :class="`intent-badge--${intent}`" data-testid="deploy-gen-intent">
        {{ intentLabel }}
      </span>
      <span v-if="phase" class="design-gen__phase" data-testid="deploy-gen-phase">{{ phase }}</span>
    </div>

    <div
      ref="activityRef"
      class="design-gen__activity"
      data-testid="deploy-gen-activity"
    >
    ...
    <div v-if="streamText" class="design-gen__preview-wrapper">
      ...
      <div class="design-gen__preview doc-body" data-testid="deploy-gen-preview" v-html="renderedStream"></div>
    </div>
  </div>
</template>
