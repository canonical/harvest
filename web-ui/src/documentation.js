...
import { escapeHtml as esc, copyText, addCopyButtons } from './utils.js';
...
export function initDocumentationPage(containerEl, initialRepos) {
  ...
  function attachListeners() {
    addCopyButtons(containerEl, '.doc-article__body pre');
